...
if __name__ == "__main__":
    ...
    org = {'id': 541158, 'name': 'Gousto'}
    nets = read_nets(dashboard, 'backup', org['id'], tag=config.backup_tag)
    #nets = dashboard.organizations.getOrganizationNetworks(organizationId=org['id'], tag=config.backup_tag)
